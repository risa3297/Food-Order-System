...
public class RegisterSellerActivity extends AppCompatActivity {
    ...
    private EditText nameET, shopNameET, phoneET, countryET, stateET, cityET, addressET, emailET, passwordET, cPasswordET;
    ...
    private void inputData() {
        ...
        if (TextUtils.isEmpty(shopName)){
            Toast.makeText(this, "Enter Stall Name", Toast.LENGTH_SHORT).show();
        }
